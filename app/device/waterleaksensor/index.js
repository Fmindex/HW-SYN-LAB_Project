...
export default class DeviceCamera extends Component {
  ...
  static navigationOptions = ({ screenProps }) => ({
    title: screenProps.t('device:water_sensor'),
    ...
    if(this.state.alert) {
      return (
        <View style={[styles.card, {flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: 257, backgroundColor: 'rgba(247, 102, 73, 0.27)'}]} >
          ...
          <Text style={{marginTop: 18, fontSize: 24, color: 'rgb(74, 74, 74)'}}>LEAK DETECTED</Text>
          <Text style={{marginTop: 8, opacity: 0.8, fontSize: 12, color: 'rgb(74, 74, 74)'}}>at 12:02 am on Sep 15,2017</Text>
        </View>
      );
    } 
    else {
